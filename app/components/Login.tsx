  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="p-6 max-w-sm w-full bg-gray-800 rounded-md shadow-md">
        <h2 className="text-2xl font-bold text-center text-gray-400 mb-8">Login</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              className={`bg-green-500 text-gray-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${!isFormValid ? "opacity-50 cursor-not-allowed" : "hover:bg-green-700"}`}
              type="submit"
